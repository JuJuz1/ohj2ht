 ...
 * @version 2023.04.13 14:10:40 // Generated by ComTest
 *
 */
...
public class IatTest {
  ...
  // Generated by ComTest BEGIN
  /** 
   * testLueTiedostosta102 
   * @throws IOException when error
   * @throws SailoException when error
   */
  @Test
  public void testLueTiedostosta102() throws IOException, SailoException {    // Iat: 102
    ...
    fail("Iat: 111 Did not throw SailoException");
    } catch(SailoException _e_){ _e_.getMessage(); }
    Iat i = new Iat(tiedosto); 
    i.lueTiedostosta(); 
    assertEquals("From: Iat line: 114", 4, i.getLkm()); 
    assertEquals("From: Iat line: 115", "0-10", i.etsiIka(1).getIka()); 
    assertEquals("From: Iat line: 116", "10-20", i.etsiIka(2).getIka()); 
    assertEquals("From: Iat line: 117", "30-40", i.etsiIka(4).getIka()); 
    VertaaTiedosto.tuhoaTiedosto(tiedosto); 
  } // Generated by ComTest END
}